...
SCPN MIF MagLIF Core — CHANGELOG
-->
...
- Diagnostic and clock semantics model
  (`src/scpn_mif_maglif_core/observability.py`), the second implemented
...
- Device configuration model (`src/scpn_mif_maglif_core/`), the first implemented
