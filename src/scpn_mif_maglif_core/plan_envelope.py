...
# SCPN MIF MagLIF Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-MIF-MAGLIF-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_mif_maglif_core.observability.CATALOGUE_BINDING`.
    plan_identifier
