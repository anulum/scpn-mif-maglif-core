...
# SCPN MIF MagLIF Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "840425fb612a0256b4709801e30b8dcfcd01d204e958769b24f682e5893373f4"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-MIF-MAGLIF-CORE"
    assert NON_CLAIMS == (
