...
# SCPN MIF MagLIF Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_mif_maglif_core/__init__.py",
    "src/scpn_mif_maglif_core/configuration.py",
    "src/scpn_mif_maglif_core/errors.py",
    "src/scpn_mif_maglif_core/observability.py",
    "src/scpn_mif_maglif_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_mif_maglif_core/parameters.py",
    "src/scpn_mif_maglif_core/physics/__init__.py",
    "src/scpn_mif_maglif_core/physics/drive.py",
    "src/scpn_mif_maglif_core/physics/compression.py",
    "src/scpn_mif_maglif_core/physics/level0.py",
    "src/scpn_mif_maglif_core/geometry/__init__.py",
    "src/scpn_mif_maglif_core/geometry/device.py",
    "src/scpn_mif_maglif_core/geometry/model.py",
    "src/scpn_mif_maglif_core/geometry/cad.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-MIF-MAGLIF-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_mif_maglif_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_mif_maglif_core" / "py.typed").is_file()
