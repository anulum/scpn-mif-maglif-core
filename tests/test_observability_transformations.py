...
# SCPN MIF MagLIF Core — transformations diagnostic tests
...
from scpn_mif_maglif_core.observability import TransformationKind
...
def test_transformation_rejects_self_mapping() -> None:
    ...
    with pytest.raises(DiagnosticPlanError, match="to itself"):
        frame_transformation(target_identifier="frm_liner_axis")
